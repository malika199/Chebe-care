    ...
    <footer className="bg-[#2a2320] text-white py-14 lg:py-16">
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            ...
            <Link to="/" className="block">
              <h3 className="text-lg font-serif font-semibold tracking-tight">CHEBE CAIR</h3>
            </Link>
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          <p className="text-[10px] uppercase tracking-[0.08em] text-[#E8DAD1]/60">&copy; 2026 CHEBE CAIR By SS. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  )
