      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-[60px] items-start">
          ...
          <div className="space-y-8 order-1 lg:order-2 max-w-[520px]">
            ...
            <p className="text-lg text-[#3A2F2A]/80 leading-relaxed">
              De N'Djamena à Paris, ville de l'amour et de l'élégance, ce secret naturel traverse les époques pour donner naissance à une marque unique : <strong className="font-medium text-[#3A2F2A]">CHEBE CARE By SS</strong>. Une rencontre entre tradition africaine et modernité européenne.
            </p>
            <a
              href="#ingredients"
